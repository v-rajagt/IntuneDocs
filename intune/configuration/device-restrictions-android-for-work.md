...
- **VPN client**: Choose a VPN client that supports Always On. Your options:
  ...
  > - You still need to configure the VPN client with a [VPN profile](vpn-settings-android-enterprise.md) or through an [app configuration profile](app-configuration-policies-use-android.md).
