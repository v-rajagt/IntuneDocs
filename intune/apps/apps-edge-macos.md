...
## Next steps
- To learn how to configure Microsoft Edge on macOS devices, see [Configure Microsoft Edge on macOS devices](https://docs.microsoft.com/en-us/deployedge/configure-microsoft-edge#configure-microsoft-edge-on-mac).
