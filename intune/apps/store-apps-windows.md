...
7. In the **App information** pane, add the app information. Depending on the app you have chosen, some of the values in this pane might have been automatically filled in:
    ...
    - **Appstore URL**: Type the App Store URL of the app that you want to create. The URL can be found by searching the [Microsoft Store](https://store.microsoft.com) for the desired app. Use the URL from the browser address bar.
