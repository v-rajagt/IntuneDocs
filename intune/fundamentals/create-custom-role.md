...
4. All the permissions and scope tags from the original role will already be selected. If you want to make changes to these, you can configure **Permissions** and **Scope (Tags)**.
5. Select **Create**. 
