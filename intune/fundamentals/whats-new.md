...
- Devices managed by System Center Configuration Manager and enrolled into co-management have almost the same rights as Intune Standalone MDM managed PCs. However, after resetting they can't be re-provisioned by using Autopilot.
