...
To complete this procedure, you must have administrator access to the console for Intune and for Jamf Pro.

1. Sign in to the [Microsoft Endpoint Manager Admin Center](https://go.microsoft.com/fwlink/?linkid=2109431).

2. Select **Tenant administration** > **Connectors and tokens** > **Partner device management**.

3. Enable the Compliance Connector for Jamf by specifying the Application ID you saved during the previous procedure into the **Jamf Azure Active Directory App ID** field.

4. Activate the connection in the Jamf Pro console:
